...
try {
    ...
    if (!$countTeachers) {
        $pdo->exec("INSERT INTO `teachers` (`id`, `name`, `position`, `level`, `subject_group`, `image_url`, `sort_order`) VALUES 
            ...
            (3, 'นายวิชาญ อักษรศิลป์', 'ครูพลศึกษาและไอที / ครูประจำชั้นประถมศึกษาปีที่ 5', 'ครูชำนาญการ (คศ.2)', 'กลุ่มสาระการเรียนรู้สุขศึกษาและพลศึกษา', 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&q=80&w=300', 3),
            (4, 'นางสาวดวงตา บุพผา', 'ครูภาษาไทยระดับต้น / ครูประจำชั้นประถมศึกษาปีที่ 1', 'ครูผู้ช่วย', 'กลุ่มสาระการเรียนรู้ภาษาไทย', 'https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&q=80&w=300', 4),
            (5, 'นางกานดา ใจซื่อ', 'ครูปฐมวัย / ครูประจำชั้นอนุบาล 3', 'ครูชำนาญการพิเศษ (คศ.3)', 'ปฐมวัย', 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&q=80&w=300', 5);");
